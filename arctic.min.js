...
this.dispatchEvent(i.COMPLETE);this._startGame()},setGameClass:function(a,b){this._gameClass=a;this._gameParams=b},start:function(){if(this._game||this._isStartedWithLoad)throw Error("do not call System.start or System.load again");this._startGame()},_startGame:function(){q.tick();this._game=new this._gameClass(this._gameParams,this);this._stage.addChild(this._game);this._prevTime=q.time;this._timer.start();this._intervalId=setInterval(s(this.run,this),1E3/this._fps)},stop:function(){clearInterval(this._intervalId)},
