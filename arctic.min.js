(function(D){function s(a,b){return function(){return a.apply(b,arguments)}}function z(a){for(var b=a.length,c=[];b--;)c[b]=a[b];return c}function u(a,b,c){if(arc.ua.isAndroid2_1)return[a,b];var d=c*Math.PI/180,c=a*Math.cos(d)-b*Math.sin(d),a=a*Math.sin(d)+b*Math.cos(d);return[c,a]}function A(a,b,c,d,e){if(arc.ua.isAndroid2_1)return[a,b,c,d];var f=u(a,b,e),g=u(a+c,b,e),j=u(a,b+d,e),d=u(a+c,b+d,e),a=Math.min(f[0],g[0],j[0],d[0]),b=Math.min(f[1],g[1],j[1],d[1]),c=Math.max(f[0],g[0],j[0],d[0]),f=Math.max(f[1],
...
var f=arguments[0],g;for(g in f){var j=f[g];if("function"==typeof j)if("$super"==c(j)[0])j=d(j,e[g]);else if("initialize"==g&&e.initialize)var k=j,j=function(){e.initialize.apply(this,arguments);k.apply(this,arguments)};b.prototype[g]=j}return b.prototype.constructor=b}}}(),i=l.create({type:null,target:null,initialize:function(a,b){this.type=a;for(var c in b)if(b.hasOwnProperty(c)&&!("type"==c||"target"==c))this[c]=b[c]}});i.PROGRESS="PROGRESS";i.COMPLETE="COMPLETE";i.ENTER_FRAME="ENTER_FRAME";i.ERROR=
...
0,this._width,this._height])},localToGlobal:function(a,b){for(var c=this,d=a,e=b,f=0,g=0;c;)d=u(d,e,c.getRotation()),f+=d[0],g+=d[1],d=c.getX(),e=c.getY(),c=c.getParent();return[f,g]},globalToLocal:function(a,b){for(var c=[],d=this,e=a,f=b;d;)c.unshift(d),d=d.getParent();for(d=0;d<c.length;d++)var g=c[d],e=e-g.getX(),f=f-g.getY(),e=u(e,f,-1*g.getRotation()),f=e[1],e=e[0];return[e,f]},hitTestObject:function(){},draw:function(){},setX:function(a){this._x=a;this._updateScreenRect()},getX:function(){return this._x},
...
d:1,e=!isNaN(e)?e:1,c=c*this._scaleX,d=d*this._scaleY,e=e*this._alpha,f=(f?f:0)+this._rotation,g=h.Image.context,j=z(this._displayArr),k=j.length,i=0;i<k;i++){var p=j[i],v=p.getX()*c,n=p.getY()*d;if(0!=f%360)var m=u(v,n,f),v=m[0],n=m[1];var m=p.getAlignX()*c*p.getScaleX(),l=p.getAlignY()*d*p.getScaleY(),m=u(m,l,p.getRotation()+f),v=v+(m[0]+a),n=n+(m[1]+b);p.getVisible()&&(this._maskObj&&(g.save(),g.beginPath(),g.rect(this._maskObj.x*c+a,this._maskObj.y*d+b,this._maskObj.width*c,this._maskObj.height*
d),g.closePath(),g.clip()),p.draw(v,n,c,d,e,f),this._maskObj&&g.restore())}this._updateSize()}},_updateSize:function(){for(var a=0,b=0,c=0,d=0,e=this._displayArr.length,f=0;f<e;f++){var g=this._displayArr[f],j=g._screenRect[0],k=g._screenRect[1],h=g._screenRect[0]+g._screenRect[2],g=g._screenRect[1]+g._screenRect[3];0==f&&(a=j,b=k,c=h,d=g);j<a&&(a=j);h>c&&(c=h);k<b&&(b=k);g>d&&(d=g)}this._originWidth=c-a;this._originHeight=d-b;this._width=this._originWidth*this._scaleX;this._height=this._originHeight*
...
e,f,g,j){c._willBeFilled=!0;d=h.Image.context;d.fillStyle=B(a);d.globalAlpha=b*j})},endFill:function(){var a=this;this._funcStack.push(function(){a._willBeFilled=!1})},beginStroke:function(a,b,c){var d=this;c||(c=1);this._funcStack.push(function(e,f,g,j,k){d._willBeStroked=!0;e=h.Image.context;e.lineWidth=a;e.strokeStyle=B(b);e.globalAlpha=c*k})},endStroke:function(){var a=this;this._funcStack.push(function(){a._willBeStroked=!1})},moveTo:function(a,b){this._funcStack.push(function(c,d,e,f){h.Image.context.moveTo((a+
...
!1;this._timer.stop()},gotoAndPlay:function(a){if(1>a||a>this._totalFrame)throw Error("Invalid frame index");this._currentFrame=a;this.play()},gotoAndStop:function(a){if(1>a||a>this._totalFrame)throw Error("Invalid frame index");this._currentFrame=a;this.stop()}});h.JSONMovieClip=l.create(h.MovieClip,{initialize:function($super,b){function c(b,g){var k,i,m,l,y;i=d(b);if(!i)throw Error("invalid animation");if("data"==i.type)return i.pos?new e(arc._system.getImage(i.data,i.pos)):new e(arc._system.getImage(i.data));
g||(g=new f(h,i.loop));k=0;for(m=i.timelines.length;k<m;k++)l=i.timelines[k],y=c(l.target),y.constructor===e&&l.align&&y.setAlign(l.align),g.addChildAt(y,0,l.keyframes);return g}function d(b){var c,d,e;c=0;for(d=g.length;c<d&&!(e=g[c],e.id==b);c++);return e}var e=arc.display.Sprite,f=arc.display.MovieClip,g=b.lib,h=b.fps,k=d(b.main);$super(h);this._shouldLoop=k.loop;c(b.main,this)}});h.SheetMovieClip=l.create(h.ImageContainer,{_currentFrame:1,_totalFrame:1,_frameWidth:0,_frameTime:0,_isPlaying:!1,
...
case m.CUBIC_IN:return h;case m.CUBIC_OUT:return k;case m.CUBIC_INOUT:return i;case m.ELASTIC_IN:return p;case m.ELASTIC_OUT:return l;case m.ELASTIC_INOUT:return n;default:return b}}},o=Math.PI/2;a.Transition=m})(t);t.Timeline=l.create({_target:null,_keyFrameObj:null,_totalFrame:0,_fps:0,_baseFrame:null,_firstFrame:0,initialize:function(a,b,c){this._target=a;this._keyFrameObj=b;c&&(this._fps=c);for(var d in this._keyFrameObj){a=b[d];c=parseInt(d,10);if(0==this._firstFrame||this._firstFrame>c)this._firstFrame=
...
document.getElementById("fps");this._setEvent()},setFullScreen:function(){this._setViewport();o.isiOS?window.addEventListener("orientationchange",s(this._setViewport,this),!0):window.addEventListener("resize",s(this._setViewport,this),!0)},_setViewport:function(){var a=window.innerWidth;a<this._canvas.width&&(a=this._canvas.width);this._canvasScale=a/this._canvas.width;this._canvas.style.width=a+"px";this._canvas.style.height=Math.floor(this._canvas.height*this._canvasScale)+"px"},_setEvent:function(){function a(a){console.log(a.pageX+
" "+a.pageY+" "+this._canvasScale);return{x:a.pageX/g._canvasScale-g._canvas.offsetLeft,y:a.pageY/g._canvasScale-g._canvas.offsetTop}}function b(a,c,d){var e=a.getParent();a.dispatchEvent(c,d);e&&b(e,c,d)}function c(a,b,d){for(var e=a._displayArr,f,g,h=e.length-1;0<=h;h--)if(f=e[h],g=a.localToGlobal(f._screenRect[0],f._screenRect[1]),g[0]<=b&&g[0]+f._screenRect[2]>=b&&g[1]<=d&&g[1]+f._screenRect[3]>=d)if(f._displayArr){if(f=c(f,b,d))return f}else return f;return null}function d(d){function l(d,e){var f=
a(d),k=c(g._stage,f.x,f.y);(h[e]=k)&&b(k,i.TOUCH_START,{x:f.x,y:f.y})}d.preventDefault();if("mousedown"==d.type)window.addEventListener("mousemove",e,!0),window.addEventListener("mouseup",f,!0),l(d,0);else for(var p=0,o=d.changedTouches.length;p<o;p++){var n=d.changedTouches[p];l(n,n.identifier)}}function e(c){function d(c,e){var f=h[e],g=a(c);f&&b(f,i.TOUCH_MOVE,{x:g.x,y:g.y})}c.preventDefault();if("mousemove"==c.type)d(c,0);else for(var e=0,f=c.changedTouches.length;e<f;e++){var g=c.changedTouches[e];
d(g,g.identifier)}}function f(c){function d(c,e){var f=h[e],g=a(c);delete h[e];f&&b(f,i.TOUCH_END,{x:g.x,y:g.y})}c.preventDefault();if("mouseup"==c.type)window.removeEventListener("mousemove",e,!0),window.removeEventListener("mouseup",f,!0),d(c,0);else for(var g=0,l=c.changedTouches.length;g<l;g++){var n=c.changedTouches[g];d(n,n.identifier)}}var g=this,h={};o.isMobile?(this._canvas.addEventListener("touchstart",d,!0),this._canvas.addEventListener("touchmove",e,!0),this._canvas.addEventListener("touchend",
...
this.dispatchEvent(i.COMPLETE);this.start()},setGameClass:function(a,b){this._gameClass=a;this._gameParams=b},start:function(){q.tick();this._game=new this._gameClass(this._gameParams,this);this._stage.addChild(this._game);this._prevTime=q.time;this._timer.start();this._intervalId=setInterval(s(this.run,this),1E3/this._fps)},stop:function(){clearInterval(this._intervalId)},run:function(){q.tick();this._runTime+=q.time-this._prevTime;this._runCount++;if(1E3<=this._runTime&&(this._realFps=1E3*this._runCount/
this._runTime,this._runCount=this._runTime=0,this._fpsElem&&(this._fpsElem.innerHTML=this._realFps),this._realFps>this._maxFps))this._maxFps=this._realFps;this._prevTime=q.time;this._disableClearRect||this._context.clearRect(0,0,this._width,this._height);this._game.update();this._stage.draw();this.dispatchEvent(i.ENTER_FRAME)},getWidth:function(){return this._width},getHeight:function(){return this._height},getImage:function(a,b){return this._imageManager.getImage(a,b)},getCanvas:function(){return this._canvas},
getStage:function(){return this._stage},getFps:function(){return this._realFps}}),H=l.create(h.DisplayObjectContainer,{_system:null,initialize:function(a,b){this._system=b},update:function(){}});window.addEventListener("load",function(){1>=window.pageYOffset&&setTimeout(function(){scrollTo(0,1)},10)},!1);D.arc={ua:o,display:h,anim:t,util:E,Class:l,Event:i,EventDispatcher:r,Timer:q,CountTimer:x,Ajax:F,ImageManager:C,System:G,Game:H}})(window);
