...
_loaded:function(){this._imageManager.removeEventListener(i.PROGRESS);this._imageManager.removeEventListener(i.COMPLETE);this.dispatchEvent(i.COMPLETE);this.start()},setGameClass:function(a,b){this._gameClass=a;this._gameParams=b},start:function(){q.tick();this._game=new this._gameClass(this._gameParams,this);this._stage.addChild(this._game);this._prevTime=q.time;this._timer.start();this._intervalId=setInterval(s(this.run,this),1E3/this._fps)},stop:function(){clearInterval(this._intervalId)},run:function(){q.tick();
