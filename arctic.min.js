(function(E){function o(a,b){return function(){return a.apply(b,arguments)}}function z(a){for(var b=a.length,c=[];b--;)c[b]=a[b];return c}function v(a,b,c){if(arc.ua.isAndroid2_1)return[a,b];var d=c*Math.PI/180,c=a*Math.cos(d)-b*Math.sin(d),a=a*Math.sin(d)+b*Math.cos(d);return[c,a]}function A(a,b,c,d,e){if(arc.ua.isAndroid2_1)return[a,b,c,d];var f=v(a,b,e),g=v(a+c,b,e),j=v(a,b+d,e),d=v(a+c,b+d,e),a=Math.min(f[0],g[0],j[0],d[0]),b=Math.min(f[1],g[1],j[1],d[1]),c=Math.max(f[0],g[0],j[0],d[0]),f=Math.max(f[1],
g[1],j[1],d[1]);return[a,b,c-a,f-b]}function B(a){return"rgb("+(a>>16)+", "+(a>>8&255)+", "+(a&255)+")"}function w(){return 90==window.orientation||-90==window.orientation?screen.height:screen.width}var F={trace:function(){try{if(1==arguments.length)console.log(arguments[0]);else{for(var a="",b=0;b<arguments.length;b++)0!=b&&(a+=","),a+=arguments[b];console.log(a)}}catch(c){}},bind:o,copyArray:z},q={};q.isiPhone=/iPhone/i.test(navigator.userAgent);q.isiPhone4=q.isiPhone&&2==window.devicePixelRatio;
q.isiPad=/iPad/i.test(navigator.userAgent);q.isiOS=q.isiPhone||q.isiPad;q.isiOS3=(q.isiPhone||q.isiPad)&&/OS\s3/.test(navigator.userAgent);q.isAndroid=/android/i.test(navigator.userAgent);q.isAndroid2_1=/android\s2\.1/i.test(navigator.userAgent);q.isMobile=q.isiOS||q.isAndroid;var l=function(){var a=function(){};return{create:function(){function b(){this.initialize.apply(this,arguments)}function c(a){a=a.toString().match(/^[\s\(]*function[^(]*\(([^)]*)\)/)[1].replace(/\/\/.*?[\r\n]|\/\*(?:.|[\r\n])*?\*\//g,
"").replace(/\s+/g,"").split(",");return 1==a.length&&!a[0]?[]:a}function d(a,b){var c=function(){var c=this,$super=void 0!==b?function(){return b.apply(c,arguments)}:void 0,d=z(arguments);d.unshift($super);return a.apply(c,d)};c.valueOf=o(a.valueOf,a);c.toString=o(a.toString,a);return c}var e="function"==typeof arguments[0]?arguments[0].prototype:{};if(!arguments[0])throw Error("define class");"function"==typeof arguments[0]&&(a.prototype=e,b.prototype=new a,Array.prototype.shift.apply(arguments));
...
"ERROR";i.TIMER="TIMER";i.TIMER_COMPLETE="TIMER_COMPLETE";i.TOUCH_START="TOUCH_START";i.TOUCH_MOVE="TOUCH_MOVE";i.TOUCH_END="TOUCH_END";var s=l.create({addEventListener:function(a,b){s.listenHash[a]||(s.listenHash[a]=[]);s.listenHash[a].push({target:this,callback:b})},removeEventListener:function(a,b){var c=s.listenHash[a];if(c){for(var d=0;d<c.length;d++){var e=c[d];e.target==this&&(b&&e.callback==b||!b)&&c.splice(d,1)}0==c.length&&delete s.listenHash[a]}},dispatchEvent:function(a,b){if(s.listenHash[a]){for(var c=
[],d=s.listenHash[a],e=0;e<d.length;e++)c[e]=d[e];d=c.length;for(e=0;e<d;e++){var f=c[e];if(f.target==this){var g=new i(a,b);g.target=this;f.callback.call(this,g)}}}}});s.listenHash={};var r=l.create({_startTime:0,_isCounting:!1,_elapsedTime:0,initialize:function(){},start:function(){this._isCounting=!0;this._startTime=r.time},stop:function(){this._isCounting=!1},reset:function(){this._isCounting=!0;this._startTime=r.time},getElapsed:function(){this._isCounting&&(this._elapsedTime=r.time-this._startTime);
return this._elapsedTime}});r.time=0;r.tick=function(){r.time=Date.now()};var x=l.create(s,{_timer:null,_currentCount:0,_repeatCount:0,_delay:0,_isRunning:!1,_updateFunc:null,initialize:function(a,b){this._timer=new r;this._delay=a;this._repeatCount=b?b:0},reset:function(){this._currentCount=0;this.stop()},start:function(){this._timer.start();this._updateFunc&&x.system.removeEventListener(i.ENTER_FRAME,this._updateFunc);this._updateFunc=o(this._update,this);x.system.addEventListener(i.ENTER_FRAME,
...
a},getRepeatCount:function(){return this._repeatCount}});x.system=null;var G=l.create(s,{_method:"GET",_params:null,_url:null,_request:null,_jsonResponse:null,_loadedCallBack:null,initialize:function(){this._request=new XMLHttpRequest;this._loadedCallBack=o(this._loaded,this)},load:function(a,b){this._url=a;this._params=b;this._request.open(this._method,this._url,!0);this._request.addEventListener("readystatechange",this._loadedCallBack,!1);this._request.send(this._params)},_loaded:function(){if(4==
...
!0);this._timer.start()},stop:function(){this._isPlaying=!1;this._timer.stop();this._shouldHide&&(this._visible=!1)},gotoAndPlay:function(a){if(1>a||a>this._totalFrame)throw Error("Invalid frame index");this._currentFrame=a;this.play()},gotoAndStop:function(a){if(1>a||a>this._totalFrame)throw Error("Invalid frame index");this._currentFrame=a;this.stop()}});h.TextField=l.create(h.DisplayObject,{_font:null,_family:"sans-serif",_textArr:null,_color:0,_align:"left",_baseline:"top",_size:10,initialize:function(){if(q.isiOS3)throw Error("Your can't use TextField in iOS3");
...
<<<<<<< HEAD
getTotalFrame:function(){return this._totalFrame}});var C=l.create(s,function(){function a(a){a.target.onload=null;a.target.onerror=null;this._loadedImgNum++;this.dispatchEvent(i.PROGRESS);this._loadedImgNum==this._loadImgNum&&this.dispatchEvent(i.COMPLETE)}function b(a){var b,e,f;b=0;for(e=this._loadingImgArr.length;b<e;b++)f=this._loadingImgArr[b],f.onload=null,f.onerror=null;this.dispatchEvent(i.ERROR);throw Error("Load Error : "+a.target.src);}return{initialize:function(){this._loadedImgNum=this._loadImgNum=
0;this._imageHash={};this._loadingImgArr=[];this._srcArr=[]},load:function(c){this._srcArr=c;this._loadedImgNum=0;this._loadImgNum=c.length;this._loadingImgArr=[];if(0===d)this.dispatchEvent(i.COMPLETE);else{for(var c=0,d=this._srcArr.length;c<d;c++){var e=this._srcArr[c],f;e.constructor==HTMLImageElement?(f=e,f.complete?a.call(this,{target:f}):(e.onload=o(a,this),e.onerror=o(b,this))):e.constructor==String&&(f=document.createElement("img"),f.src=e,f.onload=o(a,this),f.onerror=o(b,this),this._imageHash[e]=
f);this._loadingImgArr.push(f)}this._srcArr=[]}},getImage:function(a,b){return!this._imageHash[a]?null:b&&4==b.length?new h.Image(this._imageHash[a],b):new h.Image(this._imageHash[a])},getTotal:function(){return this._loadImgNum},getLoaded:function(){return this._loadedImgNum}}}()),H=l.create(s,{_fps:60,_originFps:0,_width:0,_height:0,_canvas:null,_context:null,_disableClearRect:!1,_game:null,_gameClass:null,_gameParams:null,_intervalId:null,_stage:null,_imageManager:null,_realFps:0,_runTime:0,_runCount:0,
_prevTime:0,_fpsElem:null,_maxFps:0,_adjustCount:1,_timer:null,_canvasScale:1,_ADJUST_FPS_TIME:1E4,_ADJUST_FACTOR:2.5,initialize:function(a,b,c,d){this._width=a;this._height=b;this._canvas=document.getElementById(c);this._context=this._canvas.getContext("2d");this._stage=new h.DisplayObjectContainer;this._timer=new r;this._disableClearRect=d?!0:!1;this._canvas.width=this._width;this._canvas.height=this._height;t.Animation.system=this;x.system=this;h.Image.context=this._context;arc._system=this;this._fpsElem=
document.getElementById("fps");this._setEvent();this._setScroll()},setFullScreen:function(a,b){this._fullScreenMode=a?a:"width";this._shouldShrink=b;this._setViewport();q.isiOS?window.addEventListener("orientationchange",o(this._setViewport,this),!0):window.addEventListener("resize",o(this._setViewport,this),!0)},_setViewport:function(){var a=window.innerWidth,b=window.innerHeight;!this._shouldShrink&&a<this._canvas.width&&(a=this._canvas.width);!this._shouldShrink&&b<this._canvas.height&&(b=this._canvas.height);
a/=this._canvas.width;b/=this._canvas.height;switch(this._fullScreenMode){case "width":this._canvasScale=a;break;case "height":this._canvasScale=b;break;case "all":this._canvasScale=a<b?a:b}this._canvas.style.width=Math.floor(this._canvas.width*this._canvasScale)+"px";this._canvas.style.height=Math.floor(this._canvas.height*this._canvasScale)+"px"},_setEvent:function(){function a(a){return{x:a.pageX/g._canvasScale-g._canvas.offsetLeft,y:a.pageY/g._canvasScale-g._canvas.offsetTop}}function b(a,c,d){var e=
a.getParent();a.dispatchEvent(c,d);e&&b(e,c,d)}function c(a,b,d){for(var e=a._displayArr,f,g,h=e.length-1;0<=h;h--)if(f=e[h],f.getVisible()&&(g=a.localToGlobal(f._screenRect[0],f._screenRect[1]),g[0]<=b&&g[0]+f._screenRect[2]>=b&&g[1]<=d&&g[1]+f._screenRect[3]>=d))if(f._displayArr){if(f=c(f,b,d))return f}else return f;return null}function d(d){function l(d,e){var f=a(d),k=c(g._stage,f.x,f.y);(h[e]=k)&&b(k,i.TOUCH_START,{x:f.x,y:f.y})}d.preventDefault();if("mousedown"==d.type)window.addEventListener("mousemove",
e,!0),window.addEventListener("mouseup",f,!0),l(d,0);else for(var p=0,o=d.changedTouches.length;p<o;p++){var k=d.changedTouches[p];l(k,k.identifier)}}function e(c){function d(c,e){var f=h[e],g=a(c);f&&b(f,i.TOUCH_MOVE,{x:g.x,y:g.y})}c.preventDefault();if("mousemove"==c.type)d(c,0);else for(var e=0,f=c.changedTouches.length;e<f;e++){var g=c.changedTouches[e];d(g,g.identifier)}}function f(c){function d(c,e){var f=h[e],g=a(c);delete h[e];f&&b(f,i.TOUCH_END,{x:g.x,y:g.y})}c.preventDefault();if("mouseup"==
c.type)window.removeEventListener("mousemove",e,!0),window.removeEventListener("mouseup",f,!0),d(c,0);else for(var g=0,l=c.changedTouches.length;g<l;g++){var k=c.changedTouches[g];d(k,k.identifier)}}var g=this,h={};q.isMobile?(this._canvas.addEventListener("touchstart",d,!0),this._canvas.addEventListener("touchmove",e,!0),this._canvas.addEventListener("touchend",f,!0)):this._canvas.addEventListener("mousedown",d,!0)},_setScroll:function(){function a(){1>=window.pageYOffset&&setTimeout(o(function(){scrollTo(0,
1);setTimeout(o(this._setViewport,this),1E3)},this),10)}D?window.addEventListener("load",o(a,this),!1):a.call(this)},load:function(a){this._isStartedWithLoad=!0;this._imageManager||(this._imageManager=new C);this._imageManager.addEventListener(i.PROGRESS,o(this._loading,this));this._imageManager.addEventListener(i.COMPLETE,o(this._loaded,this));this._imageManager.load(a)},_loading:function(){this.dispatchEvent(i.PROGRESS,{total:this._imageManager.getTotal(),loaded:this._imageManager.getLoaded()})},
_loaded:function(){this._imageManager.removeEventListener(i.PROGRESS);this._imageManager.removeEventListener(i.COMPLETE);this.dispatchEvent(i.COMPLETE);this._startGame()},setGameClass:function(a,b){this._gameClass=a;this._gameParams=b},start:function(){if(this._game||this._isStartedWithLoad)throw Error("do not call System.start or System.load again");this._startGame()},_startGame:function(){r.tick();this._game=new this._gameClass(this._gameParams,this);this._stage.addChild(this._game);this._prevTime=
r.time;this._timer.start();this._intervalId=setInterval(o(this.run,this),1E3/this._fps)},stop:function(){clearInterval(this._intervalId)},run:function(){r.tick();this._runTime+=r.time-this._prevTime;this._runCount++;if(1E3<=this._runTime&&(this._realFps=1E3*this._runCount/this._runTime,this._runCount=this._runTime=0,this._fpsElem&&(this._fpsElem.innerHTML=this._realFps),this._realFps>this._maxFps))this._maxFps=this._realFps;this._prevTime=r.time;this._disableClearRect||this._context.clearRect(0,0,
this._width,this._height);this._game.update();this._stage.draw();this.dispatchEvent(i.ENTER_FRAME)},getWidth:function(){return this._width},getHeight:function(){return this._height},getImage:function(a,b){return this._imageManager.getImage(a,b)},getCanvas:function(){return this._canvas},getStage:function(){return this._stage},getFps:function(){return this._realFps}}),I=l.create(h.DisplayObjectContainer,{_system:null,initialize:function(a,b){this._system=b},update:function(){}}),D=!1;window.addEventListener("load",
function(){D=!0},!1);E.arc={ua:q,display:h,anim:t,util:F,Class:l,Event:i,EventDispatcher:s,Timer:r,CountTimer:x,Ajax:G,ImageManager:C,System:H,Game:I}})(window);
=======
...
0;this._imageHash={};this._loadingImgArr=[];this._srcArr=[]},load:function(c){this._srcArr=c;this._loadedImgNum=0;this._loadImgNum=c.length;this._loadingImgArr=[];if(!c||0===c.length)this.dispatchEvent(i.COMPLETE);else{for(var c=0,d=this._srcArr.length;c<d;c++){var e=this._srcArr[c],f;e.constructor==HTMLImageElement?(f=e,f.complete?a.call(this,{target:f}):(e.onload=s(a,this),e.onerror=s(b,this))):e.constructor==String&&(f=document.createElement("img"),f.src=e,f.onload=s(a,this),f.onerror=s(b,this),
...
arc._system=this;this._fpsElem=document.getElementById("fps");this._setEvent()},setFullScreen:function(){this._setViewport();o.isiOS?window.addEventListener("orientationchange",s(this._setViewport,this),!0):window.addEventListener("resize",s(this._setViewport,this),!0)},_setViewport:function(){var a=window.innerWidth;a<this._canvas.width&&(a=this._canvas.width);this._canvasScale=a/this._canvas.width;this._canvas.style.width=a+"px";this._canvas.style.height=Math.floor(this._canvas.height*this._canvasScale)+
"px"},_setEvent:function(){function a(a){return{x:a.pageX/g._canvasScale-g._canvas.offsetLeft,y:a.pageY/g._canvasScale-g._canvas.offsetTop}}function b(a,c,d){var e=a.getParent();a.dispatchEvent(c,d);e&&b(e,c,d)}function c(a,b,d){for(var e=a._displayArr,f,g,h=e.length-1;0<=h;h--)if(f=e[h],f.getVisible()&&(g=a.localToGlobal(f._screenRect[0],f._screenRect[1]),g[0]<=b&&g[0]+f._screenRect[2]>=b&&g[1]<=d&&g[1]+f._screenRect[3]>=d))if(f._displayArr){if(f=c(f,b,d))return f}else return f;return null}function d(d){function l(d,
e){var f=a(d),k=c(g._stage,f.x,f.y);(h[e]=k)&&b(k,i.TOUCH_START,{x:f.x,y:f.y})}d.preventDefault();if("mousedown"==d.type)window.addEventListener("mousemove",e,!0),window.addEventListener("mouseup",f,!0),l(d,0);else for(var p=0,o=d.changedTouches.length;p<o;p++){var k=d.changedTouches[p];l(k,k.identifier)}}function e(c){function d(c,e){var f=h[e],g=a(c);f&&b(f,i.TOUCH_MOVE,{x:g.x,y:g.y})}c.preventDefault();if("mousemove"==c.type)d(c,0);else for(var e=0,f=c.changedTouches.length;e<f;e++){var g=c.changedTouches[e];
d(g,g.identifier)}}function f(c){function d(c,e){var f=h[e],g=a(c);delete h[e];f&&b(f,i.TOUCH_END,{x:g.x,y:g.y})}c.preventDefault();if("mouseup"==c.type)window.removeEventListener("mousemove",e,!0),window.removeEventListener("mouseup",f,!0),d(c,0);else for(var g=0,l=c.changedTouches.length;g<l;g++){var k=c.changedTouches[g];d(k,k.identifier)}}var g=this,h={};o.isMobile?(this._canvas.addEventListener("touchstart",d,!0),this._canvas.addEventListener("touchmove",e,!0),this._canvas.addEventListener("touchend",
f,!0)):this._canvas.addEventListener("mousedown",d,!0)},load:function(a){this._isStartedWithLoad=!0;this._imageManager||(this._imageManager=new C);this._imageManager.addEventListener(i.PROGRESS,s(this._loading,this));this._imageManager.addEventListener(i.COMPLETE,s(this._loaded,this));this._imageManager.load(a)},_loading:function(){this.dispatchEvent(i.PROGRESS,{total:this._imageManager.getTotal(),loaded:this._imageManager.getLoaded()})},_loaded:function(){this._imageManager.removeEventListener(i.PROGRESS);
this._imageManager.removeEventListener(i.COMPLETE);this.dispatchEvent(i.COMPLETE);this._startGame()},setGameClass:function(a,b){this._gameClass=a;this._gameParams=b},start:function(){if(this._game||this._isStartedWithLoad)throw Error("do not call System.start or System.load again");this._startGame()},_startGame:function(){q.tick();this._game=new this._gameClass(this._gameParams,this);this._stage.addChild(this._game);this._prevTime=q.time;this._timer.start();this._intervalId=setInterval(s(this.run,
this),1E3/this._fps)},stop:function(){clearInterval(this._intervalId)},run:function(){q.tick();this._runTime+=q.time-this._prevTime;this._runCount++;if(1E3<=this._runTime&&(this._realFps=1E3*this._runCount/this._runTime,this._runCount=this._runTime=0,this._fpsElem&&(this._fpsElem.innerHTML=this._realFps),this._realFps>this._maxFps))this._maxFps=this._realFps;this._prevTime=q.time;this._disableClearRect||this._context.clearRect(0,0,this._width,this._height);this._game.update();this._stage.draw();this.dispatchEvent(i.ENTER_FRAME)},
...
display:h,anim:t,util:E,Class:l,Event:i,EventDispatcher:r,Timer:q,CountTimer:x,Ajax:F,ImageManager:C,System:G,Game:H}})(window);
>>>>>>> c9a101cab89e4b3af5f4fb521aa4e587f05c7cc2
