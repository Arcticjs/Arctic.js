...
a},getTarget:function(){return this._target},getFirstFrame:function(){return this._firstFrame},_getProperty:function(a,b){b.match(/^([a-z])(.*)/);var c="get"+RegExp.$1.toUpperCase()+RegExp.$2;if(a[c])return a[c]()},_setProperty:function(a,b,c){b.match(/^([a-z])(.*)/);b="set"+RegExp.$1.toUpperCase()+RegExp.$2;if(a[b])a[b](c)}});t.KeyFrameAnimation=l.create(r,{_fps:0,_totalFrame:0,_timelineArr:null,_timer:null,_updateFunc:null,_shouldLoop:!1,_currentFrame:1,initialize:function(a,b,c){this._fps=a;this._totalFrame=
...
b&&g[1]<=d&&g[1]+f._screenRect[3]>=d)if(f._displayArr){if(f=c(f,b,d))return f}else return f;return null}function d(d){function l(d,e){var f=a(d),k=c(g._stage,f.x,f.y);(h[e]=k)&&b(k,i.TOUCH_START,{x:f.x,y:f.y})}d.preventDefault();if("mousedown"==d.type)window.addEventListener("mousemove",e,!0),window.addEventListener("mouseup",f,!0),l(d,0);else for(var p=0,o=d.changedTouches.length;p<o;p++){var k=d.changedTouches[p];l(k,k.identifier)}}function e(c){function d(c,e){var f=h[e],g=a(c);f&&b(f,i.TOUCH_MOVE,
{x:g.x,y:g.y})}c.preventDefault();if("mousemove"==c.type)d(c,0);else for(var e=0,f=c.changedTouches.length;e<f;e++){var g=c.changedTouches[e];d(g,g.identifier)}}function f(c){function d(c,e){var f=h[e],g=a(c);delete h[e];f&&b(f,i.TOUCH_END,{x:g.x,y:g.y})}c.preventDefault();if("mouseup"==c.type)window.removeEventListener("mousemove",e,!0),window.removeEventListener("mouseup",f,!0),d(c,0);else for(var g=0,l=c.changedTouches.length;g<l;g++){var k=c.changedTouches[g];d(k,k.identifier)}}var g=this,h={};
o.isMobile?(this._canvas.addEventListener("touchstart",d,!0),this._canvas.addEventListener("touchmove",e,!0),this._canvas.addEventListener("touchend",f,!0)):this._canvas.addEventListener("mousedown",d,!0)},load:function(a){this._imageManager||(this._imageManager=new C);this._imageManager.addEventListener(i.PROGRESS,s(this._loading,this));this._imageManager.addEventListener(i.COMPLETE,s(this._loaded,this));this._imageManager.load(a)},_loading:function(){this.dispatchEvent(i.PROGRESS,{total:this._imageManager.getTotal(),
loaded:this._imageManager.getLoaded()})},_loaded:function(){this._imageManager.removeEventListener(i.PROGRESS);this._imageManager.removeEventListener(i.COMPLETE);this.dispatchEvent(i.COMPLETE);this.start()},setGameClass:function(a,b){this._gameClass=a;this._gameParams=b},start:function(){q.tick();this._game=new this._gameClass(this._gameParams,this);this._stage.addChild(this._game);this._prevTime=q.time;this._timer.start();this._intervalId=setInterval(s(this.run,this),1E3/this._fps)},stop:function(){clearInterval(this._intervalId)},
run:function(){q.tick();this._runTime+=q.time-this._prevTime;this._runCount++;if(1E3<=this._runTime&&(this._realFps=1E3*this._runCount/this._runTime,this._runCount=this._runTime=0,this._fpsElem&&(this._fpsElem.innerHTML=this._realFps),this._realFps>this._maxFps))this._maxFps=this._realFps;this._prevTime=q.time;this._disableClearRect||this._context.clearRect(0,0,this._width,this._height);this._game.update();this._stage.draw();this.dispatchEvent(i.ENTER_FRAME)},getWidth:function(){return this._width},
getHeight:function(){return this._height},getImage:function(a,b){return this._imageManager.getImage(a,b)},getCanvas:function(){return this._canvas},getStage:function(){return this._stage},getFps:function(){return this._realFps}}),H=l.create(h.DisplayObjectContainer,{_system:null,initialize:function(a,b){this._system=b},update:function(){}});window.addEventListener("load",function(){1>=window.pageYOffset&&setTimeout(function(){scrollTo(0,1)},10)},!1);D.arc={ua:o,display:h,anim:t,util:E,Class:l,Event:i,
EventDispatcher:r,Timer:q,CountTimer:x,Ajax:F,ImageManager:C,System:G,Game:H}})(window);
